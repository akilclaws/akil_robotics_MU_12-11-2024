...
% Connect to Arduino
a = arduino('COM10'); % Change 'COM3' to your Arduino port
...
for t = 0.1:0.1:5 
    ...
    PWM_q1 = round((q(1)/180) * PWM_max); % Convert angle to duty cycle
    PWM_q2 = round((q(2)/180) * PWM_max); % Convert angle to duty cycle

    % Send PWM signals to Arduino
    writePWMVoltage(a, 'D3', PWM_q1/PWM_max); % Adjust 'D3' to your pin
    writePWMVoltage(a, 'D5', PWM_q2/PWM_max); % Adjust 'D5' to your pin
